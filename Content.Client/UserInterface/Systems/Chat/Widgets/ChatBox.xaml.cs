...
#pragma warning restore RA0003
{
    ...
    // #Misfits Fix — chat messages need FontTag allowed so speech verb fontSize markup is not stripped.
    ...
    public void AddLine(string message, Color color, int repeat = 0)
    {
        ...
        // #Misfits Fix — use explicit allowed tags so [font size=...] from wrapped chat is preserved.
