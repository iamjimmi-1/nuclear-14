...
namespace Content.Server.NPC.Systems
{
    ...
    /// <summary>
    ///     Handles NPC followers every tick
    ///     Its update methods and inits are called right after
    ///     <see cref="NPCSystem"/>
    ///
    ///     Organized into a partial class
    ///     just to logically seperate what it and the NPCsystem class does
    ///
    /// </summary>
    // TODO: make this its own enitity system to decouple from NPC system
    public sealed partial class NPCSystem : EntitySystem
    {
        ...
        private void FollowerSystemInit()
        {
        ...
        private void FollowerUpdate(float frameTime)
        {
