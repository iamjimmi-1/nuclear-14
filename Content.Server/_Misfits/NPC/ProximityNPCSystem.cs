...
public sealed partial class ProximityNPCSystem : EntitySystem
{
    ...
    ///                Do not need these dependencies anymore
    ...
    //       for maintainability sake - John Kieser
    /// <summary>
    ...
    private void ProcessBatch()
    {
        ...
        for (var i = _pendingIndex; i < end; i++)
        {
            ...
            // One of two comps that the 'non-generic' method is suggested
            ...
            {
                /// Misfit Change: moved redundancy to <see cref="NPCSystem.WakeNPC"/>
                _npc.WakeNPC(uid);
            }
            // Misfit end
